...
describe('useUserRole', () => {
  ...
  describe('canCreateListings', () => {
    it('should return true for superadmin', () => {
      ...
      expect(canCreateListings()).toBe(true)
    })
    ...
    it('should return false for operator', () => {
      ...
      const { canCreateListings } = useUserRole()
      expect(canCreateListings()).toBe(false)
    })
  ...
  describe('getUserRole', () => {
    it('should return "superadmin" for superadmin user', () => {
      ...
      expect(getUserRole()).toBe('superadmin')
    })
    ...
    it('should return "manager" for manager user', () => {
      authStore.setUser({
        _id: 'manager1',
        id: 'manager1',
        email: 'mgr1@test.com'
    ...
    it('should return "operator" for operator user', () => {
      authStore.setUser({
        _id: 'operator1',
        id: 'operator1',
        email: 'op1@test.com'
